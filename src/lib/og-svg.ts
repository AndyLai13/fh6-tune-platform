...
export function renderTuneOgSvg(tune: TuneForOg, car: CarForOg | null | undefined): string {
  ...
  <text x="1120" y="540" font-family="JetBrains Mono, monospace" font-size="28" font-weight="700" fill="#00d9ff" text-anchor="end">touge</text>
</svg>`;
}
...
export function renderDefaultOgSvg(): string {
  ...
  <text x="600" y="380" font-family="Inter, sans-serif" font-size="120" font-weight="800" fill="#00d9ff" text-anchor="middle">touge</text>

...
// Password is supplied via env var (CONTRIBUTOR_EDIT_PASSWORD) at generation
// time and persisted only in docs/seed-contributors.md (gitignored). Never
// embed plaintext credentials in repo source or generated SQL artifacts.
const PASSWORD = process.env.CONTRIBUTOR_EDIT_PASSWORD;
if (!PASSWORD) {
  console.error('CONTRIBUTOR_EDIT_PASSWORD env var required');
  process.exit(1);
}
...
-- Edit password recorded in docs/seed-contributors.md (gitignored)
-- Source: ${SOURCE_URL}
